...
> Not affiliated with [Igara Studio](https://igara.com/). No Aseprite binaries are distributed — everything is compiled locally from the official source, which the [Aseprite EULA](https://github.com/aseprite/aseprite/blob/main/EULA.txt) allows for personal use. If you enjoy Aseprite, and your in the position to, please consider [buying](https://www.aseprite.org/) it and supporting the devs.
>
